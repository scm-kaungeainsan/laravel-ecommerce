    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <form class="form-container" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                ...
                <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                    ...
                    <input type="submit" class="btn btn-danger btn-block mt-5" value="Register">
                </form>
            </div>
